...
# ==================================================
# Link Hosting Kalian
nikstore="raw.githubusercontent.com/nikstore/scnew/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/nikstore/scnew/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/nikstore/scnew/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/nikstore/scnew/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
